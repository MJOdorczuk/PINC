...
HEAD_	= core.h io.h aux.h population.h grid.h pusher.h multigrid.h object.h collisions.h spectral.h units.h neutrals.h cycle.h
SRC_	= io.c aux.c population.c grid.c pusher.c multigrid.c object.c collisions.c spectral.c units.c neutrals.c cycle.c
